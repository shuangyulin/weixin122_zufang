<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="房东账号" prop="fangdongzhanghao">
          <el-input v-model="ruleForm.fangdongzhanghao" 
              placeholder="房东账号" clearable  :readonly="ro.fangdongzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="房东账号" prop="fangdongzhanghao">
              <el-input v-model="ruleForm.fangdongzhanghao" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="房东姓名" prop="fangdongxingming">
          <el-input v-model="ruleForm.fangdongxingming" 
              placeholder="房东姓名" clearable  :readonly="ro.fangdongxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="房东姓名" prop="fangdongxingming">
              <el-input v-model="ruleForm.fangdongxingming" 
...
export default {
  ...
  methods: {
      ...
      this.$http({
		...
		if(json.lianxishouji!=''&&json.lianxishouji){
          ...
          this.$message.error(data.msg);
            ...
            this.zhuangtaiOptions = "待出租,已出租".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
	...
	this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../ssm48si3/upload');
        } else {
          this.$message.error(data.msg);
        }
      });

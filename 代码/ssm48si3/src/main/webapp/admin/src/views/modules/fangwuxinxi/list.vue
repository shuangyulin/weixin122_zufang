    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                ...
                <el-form-item :label="contents.inputTitle == 1 ? '面积' : ''">
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search" v-model="searchForm.mianji" placeholder="面积" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search" v-model="searchForm.mianji" placeholder="面积" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 0" v-model="searchForm.mianji" placeholder="面积" clearable></el-input>
                </el-form-item>
                <el-form-item :label="contents.inputTitle == 1 ? '租金' : ''">
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search" v-model="searchForm.zujin" placeholder="租金" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search" v-model="searchForm.zujin" placeholder="租金" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 0" v-model="searchForm.zujin" placeholder="租金" clearable></el-input>
                </el-form-item>
                <el-form-item :label="contents.inputTitle == 1 ? '所在区域' : ''">
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search" v-model="searchForm.suozaiquyu" placeholder="所在区域" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search" v-model="searchForm.suozaiquyu" placeholder="所在区域" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 0" v-model="searchForm.suozaiquyu" placeholder="所在区域" clearable></el-input>
                </el-form-item>
          <el-form-item>
    ...
    getDataList() {
      ...
      let params = {
        ...
        sort: 'id',
          ...
          if(this.searchForm.zujin!='' && this.searchForm.zujin!=undefined){
            params['zujin'] = '%' + this.searchForm.zujin + '%'
          }
          if(this.searchForm.suozaiquyu!='' && this.searchForm.suozaiquyu!=undefined){
            params['suozaiquyu'] = '%' + this.searchForm.suozaiquyu + '%'
          }
      this.$http({
    ...
    shDialog(row){
      ...
      if(row){
        this.shForm = {
          ...
          mianji: row.mianji,
          zujin: row.zujin,
          suozaiquyu: row.suozaiquyu,
          xiangxidizhi: row.xiangxidizhi,

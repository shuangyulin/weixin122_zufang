<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="租客姓名" prop="zukexingming">
          <el-input v-model="ruleForm.zukexingming" 
              placeholder="租客姓名" clearable  :readonly="ro.zukexingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="租客姓名" prop="zukexingming">
              <el-input v-model="ruleForm.zukexingming" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="家庭地址" prop="jiatingdizhi">
          <el-input v-model="ruleForm.jiatingdizhi" 
              placeholder="家庭地址" clearable  :readonly="ro.jiatingdizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="家庭地址" prop="jiatingdizhi">
              <el-input v-model="ruleForm.jiatingdizhi" 
                placeholder="家庭地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `zuke/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zukeCrossAddOrUpdateFlag = false;
                  this.parent.search();
